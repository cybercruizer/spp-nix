          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="layouts-fluid.html" class="menu-link">
                    <div data-i18n="Fluid">Orang Tua</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
                <a href="cards-basic.html" class="menu-link">
                  ...
                  <div data-i18n="Basic">Pembayaran SPP</div>
                </a>
              </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <li class="menu-item {{ \Route::is('wali.*') ? 'active' : '' }}">
                ...
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">List Wali</div>
            </a>
          </li>
          <li class="menu-item {{ \Route::is('siswa.*') ? 'active' : '' }}">
            <a href="{{ route('siswa.index') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-home-circle"></i>
              <div data-i18n="Analytics">List Siswa</div>
            </a>
          </li>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://instagram.com/anurkholis" target="_blank" class="footer-link fw-bolder">SMK Muh Mungkid</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
